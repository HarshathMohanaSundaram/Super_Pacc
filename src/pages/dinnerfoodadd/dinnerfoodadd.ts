...
/**
 * Generated class for the DinnerfoodaddPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-dinnerfoodadd',
  templateUrl: 'dinnerfoodadd.html',
})
export class DinnerfoodaddPage {
  fname:any;
  fqty:any;
  desc:any;
  price:any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad DinnerfoodaddPage');
  }
  add() {
    let url = "http://demo.sputnikinfotech.com/sputi/ion/index.php/api/dinnerfood_add";
    console.log(url);
  ...
  add1() {
    this.navCtrl.push('DinnerfoodPage');
  }
}
