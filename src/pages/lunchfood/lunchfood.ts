...
/**
 * Generated class for the LunchfoodPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-lunchfood',
  templateUrl: 'lunchfood.html',
})
export class LunchfoodPage {
  nadalist: any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad LunchfoodPage');
  }
  add(){
