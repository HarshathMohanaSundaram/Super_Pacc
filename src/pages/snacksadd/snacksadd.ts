...
/**
 * Generated class for the SnacksaddPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-snacksadd',
  templateUrl: 'snacksadd.html',
})
export class SnacksaddPage {
  fname:any;
  fqty:any;
  desc:any;
  price:any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SnacksaddPage');
  }
  add() {

    let url = "http://demo.sputnikinfotech.com/sputi/ion/index.php/api/snacksfood_add";
    console.log(url);
