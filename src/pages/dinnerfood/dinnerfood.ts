...
/**
 * Generated class for the DinnerfoodPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-dinnerfood',
  templateUrl: 'dinnerfood.html',
})
export class DinnerfoodPage {
  nadalist: any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad DinnerfoodPage');
  }
  add(){
