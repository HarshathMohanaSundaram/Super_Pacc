...
/**
 * Generated class for the BreakfirstfoodaddPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-breakfirstfoodadd',
  templateUrl: 'breakfirstfoodadd.html',
})
export class BreakfirstfoodaddPage {
  fname:any;
  fqty:any;
  desc:any;
  price:any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad BreakfirstfoodaddPage');
  }
  add() {
   
    let url = "http://demo.sputnikinfotech.com/sputi/ion/index.php/api/breakfirstfood_add";
    console.log(url);
  ...
  add1() {
    this.navCtrl.push('BreakfirstfoodPage');
  }
}
